...
if TYPE_CHECKING:
    from ..models.effect_presets_item import EffectPresetsItem
...
class Effect:
    ...
    Attributes:
        idstring (Union[Unset, str]): The unique identifier for the effect Example: A139.
        name (Union[Unset, str]): The descriptive name of the source Example: Blow.
        presets (Union[Unset, list['EffectPresetsItem']]): All the presets for this source
    """

    idstring: Union[Unset, str] = UNSET
    name: Union[Unset, str] = UNSET
    presets: Union[Unset, list["EffectPresetsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for presets_item_data in _presets or []:
            presets_item = EffectPresetsItem.from_dict(presets_item_data)
