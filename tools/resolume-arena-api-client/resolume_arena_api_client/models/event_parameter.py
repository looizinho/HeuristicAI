...
T = TypeVar("T", bound="EventParameter")
...
class EventParameter:
    ...
    Attributes:
        id (Union[Unset, int]): The unique identifier of the parameter Example: 1865335878211.
        valuetype (Union[Unset, str]): The parameter type. This is "ParamEvent" for this type Example: ParamEvent.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        event_parameter.additional_properties = d
