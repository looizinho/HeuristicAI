...
class IntegerParameter:
    ...
    Attributes:
        id (Union[Unset, int]): The unique identifier of the parameter Example: 1723491095783.
        value (Union[Unset, int]): The value for the parameter Example: 100.
        valuetype (Union[Unset, str]): The parameter type. This is "ParamNumber" for this type Example: ParamNumber.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        integer_parameter.additional_properties = d
