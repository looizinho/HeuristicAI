...
class StringParameter:
    ...
    Attributes:
        id (Union[Unset, int]): The unique identifier of the parameter Example: 1641335430527.
        value (Union[Unset, str]): The value for the parameter
        valuetype (Union[Unset, str]): The parameter type. This is "ParamString" for this type Example: ParamString.
